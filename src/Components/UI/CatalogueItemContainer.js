  ...
  return (
    <div className="border cursor-pointer rounded-md group">
        <div className="w-full h-72 relative overflow-hidden">
            ...
            <img src={imageFile} alt="" className=" w-full h-full object-cover md:object-fill object-center transform transition-all duration-700 ease-in md:group-hover:scale-110 md:group-hover:hidden" />
            <img src={imageFile2} alt="" className=" w-full h-full object-cover md:object-fill object-center transition-all duration-700 ease-out md:block  group-hover:scale-110"/>
        </div>
