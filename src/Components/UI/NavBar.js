    ...
    <div className={navbarBg ? "bg-black w-full p-0 m-0 fixed z-[100]" : "w-full p-0 m-0 fixed z-[100] bg-black"}>
        <div className= "w-11/12 mx-auto py-3.5 flex flex-row justify-between items-center text-white fill-white " >
            ...
            <div className="flex flex-row items-center gap-2">
                ...
                <div  className="w-fit md:w-[300px] rounded-md flex relative overflow-x-hidden justify-end p-1">
                    <input type="text" className="font-roboto hidden md:block  absolute w-full rounded-md pl-2.5 pr-8 text-black outline-none border-none top-0 bottom-0 right-0 left-0 m-auto text-sm" placeholder="Search for items and brands">
                    </input>
                    <div className="w-8 h-8 md:w-7 md:h-6 relative flex flex-row justify-center items-center">
                        <svg className="cursor-pointer w-full h-full fill-white md:fill-[#5d5d5d]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-8 h-8 md:w-7 md:h-7 flex flex-row justify-center items-center">
                ...
                <div className="w-8 h-8 md:w-7 md:h-7 relative flex flex-row justify-center items-center">
                    <svg className="cursor-pointer w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 11.01V11M16 11.01V11M8 8V7C8 5.93913 8.42143 4.92172 9.17157 4.17157C9.92172 3.42143 10.9391 3 12 3C13.0609 3 14.0783 3.42143 14.8284 4.17157C15.5786 4.92172 16 5.93913 16 7V8M8 8H6.84027C5.80009 8 4.93356 8.79732 4.84718 9.83391L4.18051 17.8339C4.08334 18.9999 5.00352 20 6.1736 20H17.8264C18.9965 20 19.9167 18.9999 19.8195 17.8339L19.1528 9.83391C19.0664 8.79732 18.1999 8 17.1597 8H16M8 8H16" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <div className="absolute bg-white text-black rounded-full h-4 w-4 md:h-5 md:w-5 text-center -bottom-1 md:-bottom-2 right-0 text-xs md:text-sm flex flex-row justify-center items-center font-semibold font-roboto">
                        <p>2</p>
                    </div>
                </div>
            </div>
